...
const Privacy = () => {
  ...
  return (
    <section className={`${styles.privacy} ${theme === 'dark' ? 'bgDark txtDark' : 'bgLight txtLight'}`}>
      ...
      <h4>Wer ist verantwortlich f&uuml;r die Datenerfassung auf dieserWebsite?</h4>
      <p>Die Datenverarbeitung auf dieser Website erfolgt
      ...
      <p>Telefon: +49 (0) 176 24 89 9531<br />
